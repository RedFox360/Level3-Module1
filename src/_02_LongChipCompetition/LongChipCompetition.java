...
public class LongChipCompetition {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(lcc.findTheLongestChip().getName());
    }
